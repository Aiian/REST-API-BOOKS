...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Interactive Booklist</title>
                 ...
                 <fieldset>
                     <legend>ADD NEW BOOK TO DATABASE</legend>
                         <div class="input-field">
                             <input name="name" type="text" class="input" maxlength="60" />
                             <label>Book Title</label><br>
                         </div>
                         <div class="input-field">
                             <input name="author" type="text" class="input" maxlength="40" />
                             <label>Author</label><br>
                         </div>
                         <div class="input-field">
                             <textarea name="description" type="text"class="input materialize-textarea"></textarea>
